...
global FOLDER_PATH, MUSIC_PATHS, ACTIVE_LIST
FOLDER_PATH = r'C:\\Users\\[USERNAME]\\PycharmProjects\\AIudio'
MUSIC_PATHS = [r'C:\\Users\\[USERNAME]\\PycharmProjects\\AIudio\\Music', r'C:\\Users\\[USERNAME]\\PycharmProjects\\AIudio\\Music2']
ACTIVE_LIST = []
...
def menu(start):
    ...
    if start:
        global ACTIVE_LIST, cursor, scrolling
